...
urlpatterns += [
    ...
    re_path(
        r"^rest-registration-no-password/",
        NoPasswordRegisterView.as_view(),
        name="no_password_rest_register",
    ),
    ...
    re_path(
        r"^social-login/twitter-no-view/$", twitter_login_view, name="tw_login_no_view"
    ),
    re_path(
    ...
    re_path(
        r"^social-login/twitter/connect/$", TwitterConnect.as_view(), name="tw_connect"
    ),
    re_path(
        r"^socialaccounts/$",
